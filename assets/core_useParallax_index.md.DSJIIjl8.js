...
`,U={class:"demo-source-link"},L=["href"],fs=JSON.parse('{"title":"useParallax","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useParallax/index.md","filePath":"core/useParallax/index.md","lastUpdated":1715934697000}'),J={name:"core/useParallax/index.md"},As=Object.assign(J,{setup(m){const p=V({template:{value:{welcomeSFC:Q}}}).serialize();return(c,i)=>{const k=F,e=j,n=P,h=E;return S(),C("div",null,[i[1]||(i[1]=a("h1",{id:"useparallax",tabindex:"-1"},[r("useParallax "),a("a",{class:"header-anchor",href:"#useparallax","aria-label":"Permalink to “useParallax”"},"​")],-1)),d(k,{fn:"useParallax"}),i[2]||(i[2]=a("p",null,[r("轻松创建视差效果。它使用 "),a("a",{href:"/core/useDeviceOrientation/"},[a("code",null,"useDeviceOrientation")]),r("，如果不支持方向，则回退到 "),a("a",{href:"/core/useMouse/"},[a("code",null,"useMouse")]),r("。")],-1)),i[3]||(i[3]=a("h2",{id:"示例",tabindex:"-1"},[r("示例 "),a("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),d(e,null,{default:N(()=>[a("p",U,[i[0]||(i[0]=a("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useParallax/demo.vue",target:"_blank"},"源码",-1)),a("a",{href:`https://playground.vueuse.org/?vueuse=13.5.0${B(p)}`,target:"_blank"},"playground (beta)",8,L)]),d(I)]),_:1}),i[4]||(i[4]=q(`<h2 id="使用方法" tabindex="-1">使用方法 <a class="header-anchor" href="#使用方法" aria-label="Permalink to “使用方法”">​</a></h2><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">&lt;</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">script</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> setup</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">&gt;</span></span>
