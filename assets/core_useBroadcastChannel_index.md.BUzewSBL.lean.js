import{_ as C,a as b}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.DXhCB5gE.js";import{_}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.BXCM0wL2.js";import{_ as E}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DvcLzfzF.js";import{z as B,r as f,d as F,B as x,i as h,o as p,F as w,j as i,y as k,t as D,H as t,k as v,a2 as S,a5 as P,V as R,Z as T,g as y,Y as V,w as U}from"./chunks/vue.DQfvmmyQ.js";import{t as $}from"./chunks/index.DG0WMUxM.js";import{d as I,t as N}from"./chunks/metadata.HXIr2NKd.js";import{u as A}from"./chunks/index.DK97_WvT.js";import{u as O}from"./chunks/index.BXXSfDxN.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.DXXiP3sM.js";import"./chunks/general.CGRH32nb.js";import"./chunks/index.B5l6yAbo.js";function W(c){const{name:r,window:e=I}=c,d=O(()=>e&&"BroadcastChannel"in e),s=B(!1),n=f(),o=f(),a=B(null),l=g=>{n.value&&n.value.postMessage(g)},m=()=>{n.value&&n.value.close(),s.value=!0};return d.value&&$(()=>{a.value=null,n.value=new BroadcastChannel(r);const g={passive:!0};A(n,"message",u=>{o.value=u.data},g),A(n,"messageerror",u=>{a.value=u},g),A(n,"close",()=>{s.value=!0},g)}),N(()=>{m()}),{isSupported:d,channel:n,data:o,post:l,close:m,error:a,isClosed:s}}const z={key:0},j={key:0},M={key:1},H={key:1},J=F({__name:"demo",setup(c){const{isSupported:r,data:e,post:d,error:s}=W({name:"vueuse-demo-channel"}),n=B("");return x(e,()=>{e.value&&alert(e.value)}),(o,a)=>(p(),h(w,null,[i("div",null,[i("p",null,[a[2]||(a[2]=k(" 支持: ")),i("b",null,D(t(r)),1)]),a[3]||(a[3]=i("p",null,"请在至少两个Tab中打开此页面",-1))]),t(r)?(p(),h("div",z,[i("form",{onSubmit:a[1]||(a[1]=R(l=>t(d)(n.value),["prevent"]))},[S(i("input",{"onUpdate:modelValue":a[0]||(a[0]=l=>n.value=l),type:"text"},null,512),[[P,n.value]]),a[4]||(a[4]=i("button",{type:"submit"}," 发送消息 ",-1))],32),t(e)?(p(),h("p",j," 收到: "+D(t(e)),1)):v("",!0),t(s)?(p(),h("p",M," 错误: "+D(t(s)),1)):v("",!0)])):(p(),h("div",H," 你的浏览器不支持广播频道 Web API。 "))],64))}}),L=`<script setup lang="ts">
