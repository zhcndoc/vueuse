import{_ as C,a as f}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.B34KrB-E.js";import{_ as m}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.D4TFK0oQ.js";import{_ as v}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.Dvv1reKl.js";import{d as E,z as D,a1 as b,i as d,o as g,F,j as s,k as c,a2 as O,V as _,H as B,y as i,Z as x,g as p,Y as A,w}from"./chunks/vue.BjJVtbJX.js";import{o}from"./chunks/index.BTnsuhBL.js";import{_ as R}from"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/metadata.CHQ7S0zC.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.BsCVlyoA.js";import"./chunks/index.DEO4egZK.js";import"./chunks/general.CGRH32nb.js";const y=new WeakMap,T={mounted(h,n){const e=!n.modifiers.bubble;let k;if(typeof n.value=="function")k=o(h,n.value,{capture:e});else{const[a,t]=n.value;k=o(h,a,Object.assign({capture:e},t))}y.set(h,k)},unmounted(h){const n=y.get(h);n&&typeof n=="function"?n():n==null||n.stop(),y.delete(h)}},q={class:"ml-2 relative inline-block"},P={key:0,class:"dropdown-inner"},H={class:"inner"},I=E({__name:"demo",setup(h){const n=D(!1),e=b("modalRef");o(e,t=>{console.log(t),n.value=!1});const k=D(!1),a=t=>{console.log(t),k.value=!1};return(t,l)=>(g(),d(F,null,[s("button",{onClick:l[0]||(l[0]=r=>n.value=!0)}," 打开模态框 "),s("div",q,[s("button",{onClick:l[1]||(l[1]=_(r=>k.value=!k.value,["stop"]))}," 切换下拉列表 "),k.value?O((g(),d("div",P,l[3]||(l[3]=[i(" 单击下拉列表外部将其关闭 ")]))),[[B(T),a,void 0,{bubble:!0}]]):c("",!0)]),n.value?(g(),d("div",{key:0,ref_key:"modalRef",ref:e,class:"modal"},[s("div",H,[s("button",{class:"button small",title:"Close",onClick:l[2]||(l[2]=r=>n.value=!1)}," 𝖷 "),l[4]||(l[4]=s("p",{class:"heading"}," Demo Modal ",-1)),l[5]||(l[5]=s("p",null,"单击模态框外部将其关闭",-1))])],512)):c("",!0)],64))}}),M=R(I,[["__scopeId","data-v-aac1f4b1"]]),S=`<script setup lang="ts">
