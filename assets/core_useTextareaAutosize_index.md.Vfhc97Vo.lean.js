import{_ as f,a as m}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.AiBx4Pr3.js";import{_ as C}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.Cn6cz7M5.js";import{_ as x}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DUJiisVJ.js";import{z as o,B as d,a3 as b,v,d as _,i as u,o as A,j as t,a2 as E,a5 as T,H as D,a4 as F,Z as z,g as k,Y as q,y as g,w}from"./chunks/vue.K-Nh9t7y.js";import{t as c}from"./chunks/index.84cWVi_S.js";import{d as B}from"./chunks/metadata.ByJC-ruD.js";import{u as P}from"./chunks/index.DtiJt5gQ.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.B4vKqgz9.js";import"./chunks/index.BImTs33O.js";import"./chunks/index.B2rzktNR.js";function R(i=B,e){i&&typeof i.requestAnimationFrame=="function"?i.requestAnimationFrame(e):e()}function H(i={}){const{window:e=B}=i,a=c(i?.element),p=c(i?.input??""),s=i?.styleProp??"height",n=o(1),r=o(0);function l(){if(!a.value)return;let h="";a.value.style[s]="1px",n.value=a.value?.scrollHeight;const y=b(i?.styleTarget);y?y.style[s]=`${n.value}px`:h=`${n.value}px`,a.value.style[s]=h}return d([p,a],()=>v(l),{immediate:!0}),d(n,()=>i?.onResize?.()),P(a,([{contentRect:h}])=>{r.value!==h.width&&R(e,()=>{r.value=h.width,l()})}),i?.watch&&d(i.watch,l,{immediate:!0,deep:!0}),{textarea:a,input:p,triggerResize:l}}const S=_({__name:"demo",setup(i){const{textarea:e,input:a}=H();return(p,s)=>(A(),u("div",null,[s[1]||(s[1]=t("span",null,"输入内容，文本框会自动增长：",-1)),E(t("textarea",{ref_key:"textarea",ref:e,"onUpdate:modelValue":s[0]||(s[0]=n=>F(a)?a.value=n:null),class:"resize-none",placeholder:"你在想什么？"},null,512),[[T,D(a)]])]))}}),M=`<script setup lang="ts">
