import{_ as V,a as j}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.B34KrB-E.js";import{_ as O}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.D4TFK0oQ.js";import{_ as $}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.Dvv1reKl.js";import{_ as R}from"./chunks/Note.jk4vUmz6.js";import{n as z,d as q}from"./chunks/metadata.CHQ7S0zC.js";import{u as E}from"./chunks/index.DEO4egZK.js";import{D as P,A as I,a3 as T,z as L,d as W,i as F,o as K,j as s,q as U,H as t,g as l,w as r,y as i,F as J,O as G,t as H,Z as X,Y as N}from"./chunks/vue.BjJVtbJX.js";import{_ as y}from"./chunks/Key.vue_vue_type_script_setup_true_lang.DRGiQyrO.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/index.BsCVlyoA.js";import"./chunks/general.CGRH32nb.js";const Y={ctrl:"control",command:"meta",cmd:"meta",option:"alt",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright"};function Z(x={}){const{reactive:c=!1,target:A=q,aliasMap:D=Y,passive:h=!0,onEventFired:B=z}=x,e=P(new Set),o={toJSON(){return{}},current:e},d=c?P(o):o,m=new Set,b=new Set,a=new Set;function u(k,n){k in d&&(c?d[k]=n:d[k].value=n)}function _(){e.clear();for(const k of a)u(k,!1)}function v(k,n){var f,S;const g=(f=k.key)==null?void 0:f.toLowerCase(),C=[(S=k.code)==null?void 0:S.toLowerCase(),g].filter(Boolean);g&&(n?e.add(g):e.delete(g));for(const p of C)a.add(p),u(p,n);g==="shift"&&!n?(b.forEach(p=>{e.delete(p),u(p,!1)}),b.clear()):typeof k.getModifierState=="function"&&k.getModifierState("Shift")&&n&&[...e,...C].forEach(p=>b.add(p)),g==="meta"&&!n?(m.forEach(p=>{e.delete(p),u(p,!1)}),m.clear()):typeof k.getModifierState=="function"&&k.getModifierState("Meta")&&n&&[...e,...C].forEach(p=>m.add(p))}E(A,"keydown",k=>(v(k,!0),B(k)),{passive:h}),E(A,"keyup",k=>(v(k,!1),B(k)),{passive:h}),E("blur",_,{passive:h}),E("focus",_,{passive:h});const w=new Proxy(d,{get(k,n,g){if(typeof n!="string")return Reflect.get(k,n,g);if(n=n.toLowerCase(),n in D&&(n=D[n]),!(n in d))if(/[+_-]/.test(n)){const C=n.split(/[+_-]/g).map(f=>f.trim());d[n]=I(()=>C.map(f=>T(w[f])).every(Boolean))}else d[n]=L(!1);const M=Reflect.get(k,n,g);return c?T(M):M}});return w}const Q="/vue.svg",ss="/favicon.svg",is={class:"flex flex-col md:flex-row"},as={class:"flex gap-3 justify-center"},hs={class:"flex gap-3 justify-center mt-3"},ns={class:"text-center mt-4"},ks={class:"flex mt-2 justify-center space-x-1 min-h-1.5em"},ls=W({__name:"demo",setup(x){const{shift:c,v:A,u:D,e:h,s:B,v_u_e:e,u_s_e:o,current:d}=Z(),m=I(()=>Array.from(d));return(b,a)=>{const u=R,_=R;return K(),F("div",is,[s("img",{src:Q,class:U(["h-38 py-8 m-auto transform transition duration-500",{"opacity-0":!t(e),"rotate-180":t(c)}])},null,2),s("div",null,[l(u,{class:"text-center mt-0 mb-5"},{default:r(()=>a[0]||(a[0]=[i(" 按以下键测试 ")])),_:1,__:[0]}),s("div",as,[l(y,{value:t(A)},{default:r(()=>a[1]||(a[1]=[i(" V ")])),_:1,__:[1]},8,["value"]),l(y,{value:t(D)},{default:r(()=>a[2]||(a[2]=[i(" u ")])),_:1,__:[2]},8,["value"]),l(y,{value:t(h)},{default:r(()=>a[3]||(a[3]=[i(" e ")])),_:1,__:[3]},8,["value"]),a[7]||(a[7]=s("div",{class:"mx-1"},null,-1)),l(y,{value:t(D)},{default:r(()=>a[4]||(a[4]=[i(" U ")])),_:1,__:[4]},8,["value"]),l(y,{value:t(B)},{default:r(()=>a[5]||(a[5]=[i(" s ")])),_:1,__:[5]},8,["value"]),l(y,{value:t(h)},{default:r(()=>a[6]||(a[6]=[i(" e ")])),_:1,__:[6]},8,["value"])]),s("div",hs,[l(y,{value:t(c)},{default:r(()=>a[8]||(a[8]=[i(" Shift ")])),_:1,__:[8]},8,["value"]),l(y,{value:t(e)},{default:r(()=>a[9]||(a[9]=[i(" Vue ")])),_:1,__:[9]},8,["value"]),l(y,{value:t(o)},{default:r(()=>a[10]||(a[10]=[i(" Use ")])),_:1,__:[10]},8,["value"])]),s("div",ns,[l(_,null,{default:r(()=>a[11]||(a[11]=[i("已按下的键")])),_:1,__:[11]}),s("div",ks,[(K(!0),F(J,null,G(m.value,v=>(K(),F("code",{key:v,class:"font-mono"},H(v),1))),128))])])]),s("img",{src:ss,class:U(["h-38 py-8 m-auto transform transition duration-500",{"opacity-0":!t(o),"rotate-180":t(c)}])},null,2)])}}}),ts=`<script setup lang="ts">
