import{_ as f,a as B}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as v}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{a as C,_ as b}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{z as A,a3 as u,d as w,a1 as _,i as D,o as m,j as s,y as i,t as F,H as k,a2 as E,a5 as x,Z as R,g as c,Y as y,w as S}from"./chunks/vue.DDc96eEg.js";import{u as T}from"./chunks/index.CHzdlLbS.js";import{_ as P}from"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/metadata.DSy5Z-Tw.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.C8PB9l6c.js";import"./chunks/general.tY1gtZD0.js";function I(g,h){const n=A(u(g)),t=C(()=>{const e=n.value-1;n.value=e<0?0:e,n.value<=0&&(t.pause(),h?.onComplete?.())},h?.interval??1e3,{immediate:h?.immediate??!1}),a=e=>{n.value=u(e)??u(g)},r=()=>{t.pause(),a()},o=()=>{t.isActive.value||n.value>0&&t.resume()};return{remaining:n,reset:a,stop:r,start:e=>{a(e),t.resume()},pause:t.pause,resume:o,isActive:t.isActive}}const L={class:"flex flex-col items-center"},V={class:"flex items-center gap-2 mt-4"},j={class:"flex items-center gap-2 justify-center"},O=w({__name:"demo",setup(g){const h=A(5),n=_("rocketRef"),{remaining:t,start:a,stop:r,pause:o,resume:d}=I(h,{onComplete(){n.value.classList.add("launching")},onTick(){}});function e(){n.value.classList.remove("launching"),a(h)}return T(n,"animationend",()=>{n.value.classList.remove("launching")}),(Y,l)=>(m(),D("div",L,[s("div",{ref_key:"rocketRef",ref:n,class:"rocket"}," 🚀 ",512),i(" Rocket launch in "+F(k(t))+" seconds ",1),s("div",V,[l[4]||(l[4]=i(" Countdown: ")),E(s("input",{"onUpdate:modelValue":l[0]||(l[0]=p=>h.value=p),type:"number"},null,512),[[x,h.value]])]),s("div",j,[s("button",{onClick:e}," Start "),s("button",{onClick:l[1]||(l[1]=(...p)=>k(r)&&k(r)(...p))}," Stop "),s("button",{onClick:l[2]||(l[2]=(...p)=>k(o)&&k(o)(...p))}," Pause "),s("button",{onClick:l[3]||(l[3]=(...p)=>k(d)&&k(d)(...p))}," Resume ")])]))}}),$=P(O,[["__scopeId","data-v-40a7003c"]]),N=`<script setup lang="ts">
