import{_ as A,a as f}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.DXhCB5gE.js";import{_ as D}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.BXCM0wL2.js";import{_ as b}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DvcLzfzF.js";import{A as v,a3 as r,d as _,z as o,i as g,o as c,j as a,t as l,a2 as B,a5 as P,H as y,Z as j,g as h,Y as C,y as d,w as F}from"./chunks/vue.DQfvmmyQ.js";import"./chunks/metadata.HXIr2NKd.js";import"./chunks/utils.B5e_uQLX.js";function x(t,s,i){return e=>v(()=>i(r(e),r(t),r(s)))}function E(t,s,i){return(t-s[0])/(s[1]-s[0])*(i[1]-i[0])+i[0]}function R(t,s,i=E){return x(t,s,i)}function w(t,s,i,e){return R(s,i,e)(t)}const S=["min","max"],T=_({__name:"demo",setup(t){const s=o([0,10]),i=o([10,100]),e=o(0),n=w(e,s,i);return(u,k)=>(c(),g("div",null,[a("div",null," Projection from ["+l(s.value[0])+", "+l(s.value[1])+"] to ["+l(i.value[0])+", "+l(i.value[1])+"] ",1),a("div",null,[B(a("input",{id:"input","onUpdate:modelValue":k[0]||(k[0]=p=>e.value=p),type:"range",min:s.value[0],max:s.value[1]},null,8,S),[[P,e.value,void 0,{number:!0}]])]),a("div",null," Input: "+l(e.value),1),a("div",null," Output: "+l(y(n)),1)]))}}),V=`<script setup lang="ts">
