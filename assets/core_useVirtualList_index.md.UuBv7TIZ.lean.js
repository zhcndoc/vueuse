import{_ as H,a as O}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.DXhCB5gE.js";import{_ as $}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.BXCM0wL2.js";import{_ as W}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DvcLzfzF.js";import{A as u,z as C,r as x,B as N,d as M,i as m,o as f,j as s,y as i,a2 as V,a5 as L,s as j,u as G,H as v,F as Y,O as J,n as K,t as T,m as X,Z,g as B,Y as _,w as Q}from"./chunks/vue.DQfvmmyQ.js";import{u as ss}from"./chunks/index.u2qoWwGK.js";import"./chunks/metadata.HXIr2NKd.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.DG0WMUxM.js";import"./chunks/index.DXXiP3sM.js";import"./chunks/index.C1bUUpH2.js";import"./chunks/index.BXXSfDxN.js";import"./chunks/index.B5l6yAbo.js";import"./chunks/general.CGRH32nb.js";function is(n,t){const{containerStyle:l,wrapperProps:h,scrollTo:a,calculateRange:k,currentList:p,containerRef:e}="itemHeight"in t?ls(t,n):ts(t,n);return{list:p,scrollTo:a,containerProps:{ref:e,onScroll:()=>{k()},style:l},wrapperProps:h}}function w(n){const t=C(null),l=ss(t),h=x([]),a=C(n);return{state:x({start:0,end:10}),source:a,currentList:h,size:l,containerRef:t}}function P(n,t,l){return h=>{if(typeof l=="number")return Math.ceil(h/l);const{start:a=0}=n.value;let k=0,p=0;for(let e=a;e<t.value.length;e++){const r=l(e);if(k+=r,p=e,k>h)break}return p-a}}function q(n,t){return l=>{if(typeof t=="number")return Math.floor(l/t)+1;let h=0,a=0;for(let k=0;k<n.value.length;k++){const p=t(k);if(h+=p,h>=l){a=k;break}}return a+1}}function R(n,t,l,h,{containerRef:a,state:k,currentList:p,source:e}){return()=>{const r=a.value;if(r){const g=l(n==="vertical"?r.scrollTop:r.scrollLeft),y=h(n==="vertical"?r.clientHeight:r.clientWidth),d=g-t,o=g+y+t;k.value={start:d<0?0:d,end:o>e.value.length?e.value.length:o},p.value=e.value.slice(k.value.start,k.value.end).map((c,D)=>({data:c,index:D+k.value.start}))}}}function I(n,t){return l=>typeof n=="number"?l*n:t.value.slice(0,l).reduce((a,k,p)=>a+n(p),0)}function S(n,t,l,h){N([n.width,n.height,t,l],()=>{h()})}function z(n,t){return u(()=>typeof n=="number"?t.value.length*n:t.value.reduce((l,h,a)=>l+n(a),0))}const as={horizontal:"scrollLeft",vertical:"scrollTop"};function U(n,t,l,h){return a=>{h.value&&(h.value[as[n]]=l(a),t())}}function ts(n,t){const l=w(t),{state:h,source:a,currentList:k,size:p,containerRef:e}=l,r={overflowX:"auto"},{itemWidth:g,overscan:y=5}=n,d=P(h,a,g),o=q(a,g),c=R("horizontal",y,o,d,l),D=I(g,a),A=u(()=>D(h.value.start)),b=z(g,a);S(p,t,e,c);const E=U("horizontal",c,D,e),F=u(()=>({style:{height:"100%",width:`${b.value-A.value}px`,marginLeft:`${A.value}px`,display:"flex"}}));return{scrollTo:E,calculateRange:c,wrapperProps:F,containerStyle:r,currentList:k,containerRef:e}}function ls(n,t){const l=w(t),{state:h,source:a,currentList:k,size:p,containerRef:e}=l,r={overflowY:"auto"},{itemHeight:g,overscan:y=5}=n,d=P(h,a,g),o=q(a,g),c=R("vertical",y,o,d,l),D=I(g,a),A=u(()=>D(h.value.start)),b=z(g,a);S(p,t,e,c);const E=U("vertical",c,D,e),F=u(()=>({style:{width:"100%",height:`${b.value-A.value}px`,marginTop:`${A.value}px`}}));return{calculateRange:c,scrollTo:E,containerStyle:r,wrapperProps:F,currentList:k,containerRef:e}}const ns={class:"inline-block mr-4"},hs={class:"inline-block mr-4"},ks={opacity:"70",m:"l-1"},es=M({__name:"demo",setup(n){const t=C(),l=C(""),h=Array.from(Array.from({length:99999}).keys()).map(y=>({height:y%2===0?42:84,size:y%2===0?"small":"large"})),a=u(()=>h.filter(y=>y.size.startsWith(l.value.toLowerCase()))),{list:k,containerProps:p,wrapperProps:e,scrollTo:r}=is(a,{itemHeight:y=>a.value[y].height+8,overscan:10});function g(){t.value&&r(t.value)}return(y,d)=>(f(),m("div",null,[s("div",null,[s("div",ns,[d[2]||(d[2]=i(" 跳转到索引 ")),V(s("input",{"onUpdate:modelValue":d[0]||(d[0]=o=>t.value=o),placeholder:"索引",type:"number"},null,512),[[L,t.value]])]),s("button",{type:"button",onClick:g}," 前往 ")]),s("div",null,[s("div",hs,[d[3]||(d[3]=i(" 按尺寸筛选列表 ")),V(s("input",{"onUpdate:modelValue":d[1]||(d[1]=o=>l.value=o),placeholder:"例如小号，中号，大号",type:"search"},null,512),[[L,l.value]])])]),s("div",X(v(p),{class:"h-300px overflow-auto p-2 bg-gray-500/5 rounded"}),[s("div",j(G(v(e))),[(f(!0),m(Y,null,J(v(k),({index:o,data:c})=>(f(),m("div",{key:o,class:"border border-$c-divider mb-2",style:K({height:`${c.height}px`,display:"flex",justifyContent:"center",alignItems:"center"})},[i(" 第 "+T(o)+" 行 ",1),s("span",ks,"（"+T(c.size)+"）",1)],4))),128))],16)],16)]))}}),ps=`<script setup lang="ts">
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"):"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," UseVirtualListReturn"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"<"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}},"T"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},">")])])])])],-1)),a[5]||(a[5]=_("",3)),B(e,{fn:"useVirtualList"}),a[6]||(a[6]=s("h2",{id:"更新日志",tabindex:"-1"},[i("更新日志 "),s("a",{class:"header-anchor",href:"#更新日志","aria-label":"Permalink to “更新日志”"},"​")],-1)),B(r,{fn:"useVirtualList"})])}}});export{Fs as __pageData,_s as default};
