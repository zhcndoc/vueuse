import{_ as v,a as F}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.DXhCB5gE.js";import{_}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.BXCM0wL2.js";import{_ as E}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DvcLzfzF.js";import{_ as C}from"./chunks/Note.B_ue-6bE.js";import{d as H,z as T,i as o,o as d,F as D,j as s,a2 as w,g as l,t as m,H as n,a5 as x,w as A,y as h,O as S,Z as $,Y as P}from"./chunks/vue.DQfvmmyQ.js";import{u as U}from"./chunks/index.CVfU17FT.js";import{t as z}from"./chunks/filters.DSKJ-Ken.js";import{u as Y}from"./chunks/index.DvdvV9Up.js";import{f as O}from"./chunks/index.Dn4UagWc.js";import"./chunks/metadata.HXIr2NKd.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/index.KAi2LWa5.js";import"./chunks/index.DMx8Y1Rz.js";import"./chunks/index.D-ZEots4.js";import"./chunks/index.CyaQpZZu.js";function V(y,k={}){const{throttle:e=200,trailing:p=!0}=k,a=z(e,p);return{...U(y,{...k,eventFilter:a})}}const M=["disabled"],N=["disabled"],I={class:"code-block mt-4"},j={class:"opacity-50 mr-2 font-mono"},q={class:"font-mono"},J=H({__name:"demo",setup(y){function k(f){return O(new Date(f),"YYYY-MM-DD HH:mm:ss")}const e=T(1e3),{count:p,inc:a,dec:r}=Y(),{history:g,undo:u,redo:c,canUndo:b,canRedo:B}=V(p,{deep:!0,throttle:e,capacity:10,trailing:!0});return(f,i)=>{const R=C;return d(),o(D,null,[s("div",null,"计数："+m(n(p)),1),s("button",{onClick:i[0]||(i[0]=t=>n(a)())}," 增加 "),s("button",{onClick:i[1]||(i[1]=t=>n(r)())}," 减少 "),i[6]||(i[6]=s("span",{class:"ml-2"},"/",-1)),s("button",{disabled:!n(b),onClick:i[2]||(i[2]=t=>n(u)())}," 撤销 ",8,M),s("button",{disabled:!n(B),onClick:i[3]||(i[3]=t=>n(c)())}," 重做 ",8,N),i[7]||(i[7]=s("br",null,null,-1)),i[8]||(i[8]=s("span",null,"延迟时间（毫秒）：",-1)),w(s("input",{"onUpdate:modelValue":i[4]||(i[4]=t=>e.value=t),type:"number"},null,512),[[x,e.value]]),i[9]||(i[9]=s("br",null,null,-1)),i[10]||(i[10]=s("br",null,null,-1)),l(R,null,{default:A(()=>i[5]||(i[5]=[h("历史记录（为演示目的限制为10条记录）")])),_:1}),s("div",I,[(d(!0),o(D,null,S(n(g),t=>(d(),o("div",{key:t.timestamp},[s("span",j,m(k(t.timestamp)),1),s("span",q,"{ value: "+m(t.snapshot)+" }",1)]))),128))])],64)}}}),L=`<script setup lang="ts">
