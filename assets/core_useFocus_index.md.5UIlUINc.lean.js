...
`,N={class:"demo-source-link"},I=["href"],X=JSON.parse('{"title":"useFocus","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useFocus/index.md","filePath":"core/useFocus/index.md","lastUpdated":1739784586000}'),U={name:"core/useFocus/index.md"},ss=Object.assign(U,{setup(y){const h=V({template:{value:{welcomeSFC:M}}}).serialize();return(g,i)=>{const n=E,t=_,c=v,a=C;return r(),p("div",null,[i[1]||(i[1]=s("h1",{id:"usefocus",tabindex:"-1"},[l("useFocus "),s("a",{class:"header-anchor",href:"#usefocus","aria-label":"Permalink to “useFocus”"},"​")],-1)),d(n,{fn:"useFocus"}),i[2]||(i[2]=s("p",null,[l("用于跟踪或设置 DOM 元素的焦点状态的响应式工具。状态变化反映了目标元素是否为焦点元素。从外部设置响应式值将触发对应于 "),s("code",null,"true"),l(" 和 "),s("code",null,"false"),l(" 值的 "),s("code",null,"focus"),l(" 和 "),s("code",null,"blur"),l(" 事件。")],-1)),i[3]||(i[3]=s("h2",{id:"示例",tabindex:"-1"},[l("示例 "),s("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),d(t,null,{default:F(()=>[s("p",N,[i[0]||(i[0]=s("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useFocus/demo.vue",target:"_blank"},"源码",-1)),s("a",{href:`https://playground.vueuse.org/?vueuse=13.6.0${e(h)}`,target:"_blank"},"playground (beta)",8,I)]),d(O)]),_:1}),i[4]||(i[4]=S("",13)),d(c,{fn:"useFocus"}),i[5]||(i[5]=s("h2",{id:"更新日志",tabindex:"-1"},[l("更新日志 "),s("a",{class:"header-anchor",href:"#更新日志","aria-label":"Permalink to “更新日志”"},"​")],-1)),d(a,{fn:"useFocus"})])}}});export{X as __pageData,ss as default};
