import{_ as c,a as u}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as A}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as D}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{t as B}from"./chunks/index.Cic7SbUz.js";import{g as f}from"./chunks/metadata.DSy5Z-Tw.js";import{B as v,d as m,z as b,A as C,i as o,o as y,F,j as i,Z as _,g as k,Y as E,y as g,w as x,H as P}from"./chunks/vue.DDc96eEg.js";import"./chunks/utils.B5e_uQLX.js";function R(r=null,h={}){const{baseUrl:e="",rel:p="icon",document:s=f}=h,l=B(r),d=a=>{const n=s?.head.querySelectorAll(`link[rel*="${p}"]`);if(!n||n.length===0){const t=s?.createElement("link");t&&(t.rel=p,t.href=`${e}${a}`,t.type=`image/${a.split(".").pop()}`,s?.head.append(t));return}n?.forEach(t=>t.href=`${e}${a}`)};return v(l,(a,n)=>{typeof a=="string"&&a!==n&&d(a)},{immediate:!0}),l}const $=m({__name:"demo",setup(r){const h=b("vueuse"),e=C(()=>h.value==="vue"?"vue.png":"favicon-32x32.png");return R(e,{baseUrl:"/",rel:"icon"}),(p,s)=>(y(),o(F,null,[s[2]||(s[2]=i("div",null," 更改 favicon ",-1)),i("button",{onClick:s[0]||(s[0]=l=>h.value="vue")}," Vue "),i("button",{onClick:s[1]||(s[1]=l=>h.value="vueuse")}," VueUse ")],64))}}),w=`<script setup lang="ts">
