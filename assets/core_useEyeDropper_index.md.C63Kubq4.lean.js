import{_ as c,a as u}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as A}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as B}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{u as E}from"./chunks/index.rocSL1WN.js";import{z as f,d as m,i as d,H as n,o,j as s,t as y,y as h,n as b,Z as v,g as l,Y as _,w as C}from"./chunks/vue.DDc96eEg.js";import"./chunks/metadata.DSy5Z-Tw.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.BrP_zX4n.js";function x(r={}){const{initialValue:e=""}=r,p=E(()=>typeof window<"u"&&"EyeDropper"in window),t=f(e);async function i(a){if(!p.value)return;const k=await new window.EyeDropper().open(a);return t.value=k.sRGBHex,k}return{isSupported:p,sRGBHex:t,open:i}}const F={key:0},S=["disabled"],R={key:1},P=m({__name:"demo",setup(r){const{isSupported:e,open:p,sRGBHex:t}=x();return(i,a)=>n(e)?(o(),d("div",F,[s("div",null,"是否支持: "+y(n(e)),1),s("div",null,[a[1]||(a[1]=h("sRGB十六进制: ")),s("span",{style:b({color:n(t)})},y(n(t)),5)]),s("button",{disabled:!n(e),onClick:a[0]||(a[0]=()=>n(p)())}," 打开取色器 ",8,S)])):(o(),d("div",R,a[2]||(a[2]=[s("span",null,"你的浏览器不支持此功能",-1)])))}}),w=`<script lang="ts" setup>
