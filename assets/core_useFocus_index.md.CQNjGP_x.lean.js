import{_ as C,a as _}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.B34KrB-E.js";import{_ as E}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.D4TFK0oQ.js";import{_ as x}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.Dvv1reKl.js";import{_ as R}from"./chunks/Note.jk4vUmz6.js";import{u as T}from"./chunks/index.BsCVlyoA.js";import{u as b}from"./chunks/index.DEO4egZK.js";import{z as w,A as F,B as P,d as V,a1 as f,i as r,o as d,j as s,g as o,w as v,H as e,F as D,y as l,q as B,Z as S,Y as q}from"./chunks/vue.BjJVtbJX.js";import{_ as $}from"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/metadata.CHQ7S0zC.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/general.CGRH32nb.js";function m(A,g={}){const{initialValue:k=!1,focusVisible:c=!1,preventScroll:i=!1}=g,n=w(!1),t=F(()=>T(A)),u={passive:!0};b(t,"focus",p=>{var h,y;(!c||(y=(h=p.target).matches)!=null&&y.call(h,":focus-visible"))&&(n.value=!0)},u),b(t,"blur",()=>n.value=!1,u);const a=F({get:()=>n.value,set(p){var h,y;!p&&n.value?(h=t.value)==null||h.blur():p&&!n.value&&((y=t.value)==null||y.focus({preventScroll:i}))}});return P(t,()=>{a.value=k},{immediate:!0,flush:"post"}),{focused:a}}const O=V({__name:"demo",setup(A){const g=f("text"),k=f("input"),c=f("button"),{focused:i}=m(g),{focused:n}=m(k,{initialValue:!0}),{focused:t}=m(c);return(u,a)=>{const p=R;return d(),r("div",null,[s("p",{ref_key:"text",ref:g,class:"demo-el px-2 rounded",tabindex:"0"}," 可获得焦点的段落 ",512),s("input",{ref_key:"input",ref:k,class:"demo-el",type:"text",placeholder:"可获得焦点的输入框"},null,512),s("button",{ref_key:"button",ref:c,class:"demo-el button"}," 可获得焦点的按钮 ",512),a[3]||(a[3]=s("hr",null,null,-1)),o(p,{class:"mb-2"},{default:v(()=>[e(i)?(d(),r(D,{key:0},[l(" 段落获得焦点 ")],64)):e(n)?(d(),r(D,{key:1},[l(" 输入框获得焦点 ")],64)):e(t)?(d(),r(D,{key:2},[l(" 按钮获得焦点 ")],64)):(d(),r(D,{key:3},[l("   ")],64))]),_:1}),s("button",{class:B(["button small !ml-0",{orange:e(i)}]),onClick:a[0]||(a[0]=h=>i.value=!e(i))}," 聚焦文本 ",2),s("button",{class:B(["button small",{orange:e(n)}]),onClick:a[1]||(a[1]=h=>n.value=!e(n))}," 聚焦输入框 ",2),s("button",{class:B(["button small",{orange:e(t)}]),onClick:a[2]||(a[2]=h=>t.value=!e(t))}," 聚焦按钮 ",2)])}}}),M=$(O,[["__scopeId","data-v-37c9ce85"]]),N=`<script setup lang="ts">
