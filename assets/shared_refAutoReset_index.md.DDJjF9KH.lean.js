import{_ as c,a as f}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.aYHrlqwd.js";import{_ as A}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as D}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.BPSCnKkW.js";import{t as m}from"./chunks/metadata.BfYDMb5p.js";import{ac as b,a3 as r,d as _,i as o,o as g,j as i,t as B,H as u,Z as R,g as n,Y as v,y as d,w as C}from"./chunks/vue.DDc96eEg.js";import"./chunks/utils.B5e_uQLX.js";function F(l,e=1e4){return b((t,h)=>{let s=r(l),a;const k=()=>setTimeout(()=>{s=r(l),h()},r(e));return m(()=>{clearTimeout(a)}),{get(){return t(),s},set(p){s=p,h(),clearTimeout(a),a=k()}}})}const E=_({__name:"demo",setup(l){const e=F("Default message",1e3);function t(){e.value="Changed"}return(h,s)=>(g(),o("div",null,[i("button",{onClick:s[0]||(s[0]=a=>t())}," 更改 message "),i("p",null,B(u(e)),1)]))}}),x=`<script setup lang="ts">
