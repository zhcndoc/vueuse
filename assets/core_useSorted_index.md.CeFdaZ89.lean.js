import{_ as f,a as C}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.DXhCB5gE.js";import{_ as b}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.BXCM0wL2.js";import{_ as v}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DvcLzfzF.js";import{A as B,a3 as A,L as E,a4 as S,d as _,z as x,i as u,o as m,F as T,j as s,y as d,a2 as J,a5 as j,t as y,H as o,Z as O,g as r,Y as P,w as R}from"./chunks/vue.DQfvmmyQ.js";import{r as D}from"./chunks/metadata.HXIr2NKd.js";import"./chunks/utils.B5e_uQLX.js";const U=(h,n)=>h.sort(n),g=(h,n)=>h-n;function c(...h){const[n]=h;let t=g,k={};h.length===2?typeof h[1]=="object"?(k=h[1],t=k.compareFn??g):t=h[1]??g:h.length>2&&(t=h[1]??g,k=h[2]??{});const{dirty:a=!1,sortFn:e=U}=k;return a?(E(()=>{const l=e(A(n),t);S(n)?n.value=l:n.splice(0,n.length,...l)}),n):B(()=>e([...A(n)],t))}const w={class:"flex items-center"},V={class:"mt-10"},$=_({__name:"demo",setup(h){const n=[{name:"John",age:40},{name:"Jane",age:20},{name:"Joe",age:30},{name:"Jenny",age:22}],t=c(n,(p,i)=>p.age-i.age),k=x(""),a=B(()=>k.value.split(",")),e=c(a);function l(){const p=[];for(let i=0;i<D(10,20);i++)p.push(D(0,100));k.value=p.join(",")}return l(),(p,i)=>(m(),u(T,null,[s("div",null,[s("div",w,[i[1]||(i[1]=d(" 输入： ")),J(s("input",{"onUpdate:modelValue":i[0]||(i[0]=F=>k.value=F),type:"text"},null,512),[[j,k.value]])]),s("div",null,[s("button",{onClick:l}," 随机 ")]),d(" 输出："+y(o(e)),1)]),s("div",V,[i[2]||(i[2]=s("div",null,"对象属性排序：",-1)),i[3]||(i[3]=s("div",null,"输入：",-1)),s("div",null,y(n)),i[4]||(i[4]=s("div",{class:"mt-5"}," 输出： ",-1)),s("div",null,y(o(t)),1)])],64))}}),N=`<script setup lang="ts">
