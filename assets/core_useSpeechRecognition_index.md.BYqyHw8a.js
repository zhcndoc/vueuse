import{_ as U,a as T}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.B34KrB-E.js";import{_ as I}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.D4TFK0oQ.js";import{_ as N}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.Dvv1reKl.js";import{_ as V}from"./chunks/Note.jk4vUmz6.js";import{z as D,a3 as L,B as S,d as G,i as o,o as d,H as y,y as i,j as s,k as w,a2 as F,al as x,F as $,g as A,w as E,t as P,n as j,Z as q,Y as z}from"./chunks/vue.BjJVtbJX.js";import{t as M}from"./chunks/index.CFuYet67.js";import{d as O,t as W}from"./chunks/metadata.CHQ7S0zC.js";import{u as J}from"./chunks/index.D6Ixh6S-.js";import{_ as H}from"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.CBIpye6U.js";function Y(_={}){const{interimResults:r=!0,continuous:v=!0,maxAlternatives:m=1,window:n=O}=_,k=M(_.lang||"en-US"),h=D(!1),c=D(!1),f=D(""),g=D(void 0);let t;const b=()=>{h.value=!0},B=()=>{h.value=!1},u=(a=!h.value)=>{a?b():B()},p=n&&(n.SpeechRecognition||n.webkitSpeechRecognition),e=J(()=>p);return e.value&&(t=new p,t.continuous=v,t.interimResults=r,t.lang=L(k),t.maxAlternatives=m,t.onstart=()=>{h.value=!0,c.value=!1},S(k,a=>{t&&!h.value&&(t.lang=a)}),t.onresult=a=>{const l=a.results[a.resultIndex],{transcript:R}=l[0];c.value=l.isFinal,f.value=R,g.value=void 0},t.onerror=a=>{g.value=a},t.onend=()=>{h.value=!1,t.lang=L(k)},S(h,(a,l)=>{a!==l&&(a?t.start():t.stop())})),W(()=>{B()}),{isSupported:e,isListening:h,isFinal:c,recognition:t,result:f,error:g,toggle:u,start:b,stop:B}}const Z={key:0},K={key:1},Q={"space-x-4":""},X={class:"radio"},ss={class:"radio"},is={class:"radio"},es={key:2,class:"mt-4"},ns={key:1},as={key:2},ts=G({__name:"demo",setup(_){const r=D("zh-CN");function v(p,e){const a=p.slice(0);let l=p.length,R,C;for(;l--;)C=Math.floor((l+1)*Math.random()),R=a[C],a[C]=a[l],a[l]=R;return a.slice(0,e)}const m=["aqua","azure","beige","bisque","black","blue","brown","chocolate","coral","crimson","cyan","fuchsia","ghostwhite","gold","goldenrod","gray","green","indigo","ivory","khaki","lavender","lime","linen","magenta","maroon","moccasin","navy","olive","orange","orchid","peru","pink","plum","purple","red","salmon","sienna","silver","snow","tan","teal","thistle","tomato","turquoise","violet","white","yellow","transparent"],n=`#JSGF V1.0; grammar colors; public <color> = ${m.join(" | ")} ;`,k=Y({lang:r,continuous:!0}),h=D("transparent");if(k.isSupported.value){const p=window.SpeechGrammarList||window.webkitSpeechGrammarList,e=new p;e.addFromString(n,1),k.recognition.grammars=e,S(k.result,()=>{for(const a of k.result.value.toLowerCase().split(" ").reverse())if(m.includes(a)){h.value=a;break}})}const c=D([]);function f(){h.value="transparent",k.result.value="",c.value=v(m,5),k.start()}const{isListening:g,isSupported:t,stop:b,result:B}=k,u=D(r.value);return S(r,p=>g.value?null:u.value=p),S(g,p=>p?null:u.value=r.value),(p,e)=>{const a=V;return d(),o("div",null,[y(t)?(d(),o("div",K,[s("div",Q,[s("label",X,[F(s("input",{"onUpdate:modelValue":e[0]||(e[0]=l=>r.value=l),type:"radio",value:"zh-CN"},null,512),[[x,r.value]]),e[5]||(e[5]=s("span",null,"普通话",-1))]),s("label",ss,[F(s("input",{"onUpdate:modelValue":e[1]||(e[1]=l=>r.value=l),value:"en-US",type:"radio"},null,512),[[x,r.value]]),e[6]||(e[6]=s("span",null,"英语（美国）",-1))]),s("label",is,[F(s("input",{"onUpdate:modelValue":e[2]||(e[2]=l=>r.value=l),value:"fr",type:"radio"},null,512),[[x,r.value]]),e[7]||(e[7]=s("span",null,"法语",-1))])]),y(g)?w("",!0):(d(),o("button",{key:0,onClick:f}," 按住并讲话 ")),y(g)?(d(),o("button",{key:1,class:"orange",onClick:e[3]||(e[3]=(...l)=>y(b)&&y(b)(...l))}," 停止 ")):w("",!0),y(g)?(d(),o("div",es,[u.value==="zh-CN"?(d(),o($,{key:0},[A(a,{class:"mb-2"},{default:E(()=>e[8]||(e[8]=[s("b",null,"请说一个颜色",-1)])),_:1,__:[8]}),A(a,{class:"mb-2"},{default:E(()=>[i(" 尝试："+P(c.value.join(", ")),1)]),_:1})],64)):u.value==="en-US"?(d(),o("p",ns," 说一些英语！ ")):u.value==="fr"?(d(),o("p",as," 说一些法语！ ")):w("",!0),s("p",{class:"tag",style:j(u.value==="en-US"?{background:h.value}:{})},P(y(B)),5)])):w("",!0)])):(d(),o("div",Z,e[4]||(e[4]=[i(" 你的浏览器不支持语音识别 API， "),s("a",{href:"https://caniuse.com/mdn-api_speechrecognition",target:"_blank"},"查看更多详情",-1)])))])}}}),ls=H(ts,[["__scopeId","data-v-c0219e09"]]),hs=`<script setup lang="ts">
...
`,rs={class:"demo-source-link"},ks=["href"],bs=JSON.parse('{"title":"useSpeechRecognition","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useSpeechRecognition/index.md","filePath":"core/useSpeechRecognition/index.md","lastUpdated":1715934697000}'),ps={name:"core/useSpeechRecognition/index.md"},Bs=Object.assign(ps,{setup(_){const v=q({template:{value:{welcomeSFC:hs}}}).serialize();return(m,n)=>{const k=N,h=I,c=U,f=T;return d(),o("div",null,[n[1]||(n[1]=s("h1",{id:"usespeechrecognition",tabindex:"-1"},[i("useSpeechRecognition "),s("a",{class:"header-anchor",href:"#usespeechrecognition","aria-label":"Permalink to “useSpeechRecognition”"},"​")],-1)),A(k,{fn:"useSpeechRecognition"}),n[2]||(n[2]=s("p",null,[i("响应式 "),s("a",{href:"https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition",target:"_blank",rel:"noreferrer"},"SpeechRecognition"),i("。")],-1)),n[3]||(n[3]=s("blockquote",null,[s("p",null,[s("a",{href:"https://caniuse.com/mdn-api_speechrecognitionevent",target:"_blank",rel:"noreferrer"},"Can I use?")])],-1)),n[4]||(n[4]=s("h2",{id:"示例",tabindex:"-1"},[i("示例 "),s("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),A(h,null,{default:E(()=>[s("p",rs,[n[0]||(n[0]=s("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useSpeechRecognition/demo.vue",target:"_blank"},"源码",-1)),s("a",{href:`https://playground.vueuse.org/?vueuse=13.3.0${y(v)}`,target:"_blank"},"playground (beta)",8,ks)]),A(ls)]),_:1}),n[5]||(n[5]=z(`<h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-label="Permalink to “用法”">​</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> useSpeechRecognition</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;"> &#39;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">@vueuse/core</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  isSupported</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  isListening</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  isFinal</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  result</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  start</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;">  stop</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">}</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> =</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665;"> useSpeechRecognition</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">()</span></span></code></pre></div><h3 id="选项" tabindex="-1">选项 <a class="header-anchor" href="#选项" aria-label="Permalink to “选项”">​</a></h3><p>以下显示了选项的默认值，它们将直接传递给 <a href="https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition" target="_blank" rel="noreferrer">SpeechRecognition API</a>。</p><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665;">useSpeechRecognition</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">({</span></span>
...
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">  interimResults</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: </span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">true</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#998418;--shiki-dark:#B8A965;">  continuous</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">: </span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">true</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">,</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">})</span></span></code></pre></div><h2 id="类型声明" tabindex="-1">类型声明 <a class="header-anchor" href="#类型声明" aria-label="Permalink to “类型声明”">​</a></h2>`,6)),n[6]||(n[6]=s("details",null,[s("summary",{op50:"",italic:"","cursor-pointer":"","select-none":""},"显示类型声明"),s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes vitesse-light vitesse-dark",style:{"--shiki-light":"#393a34","--shiki-dark":"#dbd7caee","--shiki-light-bg":"#ffffff","--shiki-dark-bg":"#121212"},tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"export"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}}," interface"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," UseSpeechRecognitionOptions"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}}," extends"),s("span",{style:{"--shiki-light":"#59873A","--shiki-dark":"#80A665"}}," ConfigurableWindow"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}}," {")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"export"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}}," type"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," UseSpeechRecognitionReturn"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}}," ="),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," ReturnType"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"<"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}},"typeof"),s("span",{style:{"--shiki-light":"#B07D48","--shiki-dark":"#BD976A"}}," useSpeechRecognition"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},">")])])])])],-1)),n[7]||(n[7]=z('<h2 id="源码" tabindex="-1">源码 <a class="header-anchor" href="#源码" aria-label="Permalink to “源码”">​</a></h2><p><a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSpeechRecognition/index.ts" target="_blank" rel="noreferrer">源码</a> • <a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSpeechRecognition/demo.vue" target="_blank" rel="noreferrer">演示</a> • <a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSpeechRecognition/index.md" target="_blank" rel="noreferrer">文档</a></p><h2 id="贡献者" tabindex="-1">贡献者 <a class="header-anchor" href="#贡献者" aria-label="Permalink to “贡献者”">​</a></h2>',3)),A(c,{fn:"useSpeechRecognition"}),n[8]||(n[8]=s("h2",{id:"更新日志",tabindex:"-1"},[i("更新日志 "),s("a",{class:"header-anchor",href:"#更新日志","aria-label":"Permalink to “更新日志”"},"​")],-1)),A(f,{fn:"useSpeechRecognition"})])}}});export{bs as __pageData,Bs as default};
