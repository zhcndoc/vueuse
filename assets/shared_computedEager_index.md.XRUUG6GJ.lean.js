import{_,a as b}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.AiBx4Pr3.js";import{_ as B}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.Cn6cz7M5.js";import{_ as E}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DUJiisVJ.js";import{_ as D}from"./chunks/BooleanDisplay.vue_vue_type_script_setup_true_lang.BUf_gkVe.js";import{z as r,L as C,G as x,d as u,J as A,i as o,o as g,y as d,g as t,H as y,A as F,F as T,j as i,t as c,Z as R,Y as m,w}from"./chunks/vue.K-Nh9t7y.js";import"./chunks/metadata.ByJC-ruD.js";import"./chunks/utils.B5e_uQLX.js";function $(l,e){const a=r();return C(()=>{a.value=l()},{...e,flush:"sync"}),x(a)}const k=r(0),P=u({__name:"EagerDemo",emits:["update"],setup(l,{emit:e}){const a=e;A(()=>a("update"));const h=$(()=>k.value>5);return(s,n)=>{const p=D;return g(),o("div",null,[n[0]||(n[0]=d(" 已超过5: ",-1)),t(p,{value:y(h)},null,8,["value"])])}}}),V=u({__name:"LazyDemo",emits:["update"],setup(l,{emit:e}){const a=e;A(()=>a("update"));const h=F(()=>k.value>5);return(s,n)=>{const p=D;return g(),o("div",null,[n[0]||(n[0]=d(" 已超过5: ",-1)),t(p,{value:h.value},null,8,["value"])])}}}),S={grid:"","grid-cols-2":""},z={"font-mono":""},O={"font-mono":""},j={"mt-4":"","font-mono":""},N=u({__name:"demo",setup(l){const e=r(0),a=r(0);return(h,s)=>(g(),o(T,null,[i("div",S,[i("div",null,[s[4]||(s[4]=i("span",{"text-primary":"","font-bold":""},"惰性计算",-1)),i("div",z,[t(V,{onUpdate:s[0]||(s[0]=n=>e.value++)}),i("div",null," 渲染次数: "+c(e.value),1)])]),i("div",null,[s[5]||(s[5]=i("span",{"text-primary":"","font-bold":""},"急性计算",-1)),i("div",O,[t(P,{onUpdate:s[1]||(s[1]=n=>a.value++)}),i("div",null,"渲染次数: "+c(a.value),1)])])]),i("div",j," 计数: "+c(y(k)),1),i("button",{secondary:"",onClick:s[2]||(s[2]=n=>k.value--)}," 减少 "),i("button",{onClick:s[3]||(s[3]=n=>k.value++)}," 增加 ")],64))}}),I=`<script setup lang="ts">
