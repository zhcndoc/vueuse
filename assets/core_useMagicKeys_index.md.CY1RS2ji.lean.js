import{_ as N,a as I}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as V}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as j}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{_ as w}from"./chunks/Note.BA4Afsl9.js";import{n as O,d as $}from"./chunks/metadata.DSy5Z-Tw.js";import{u as _}from"./chunks/index.CHzdlLbS.js";import{D as S,A as U,a3 as R,z,d as q,i as E,o as F,j as s,q as P,H as e,g as t,w as r,y as i,F as L,O as W,t as J,Z as G,Y as T}from"./chunks/vue.DDc96eEg.js";import{_ as y}from"./chunks/Key.vue_vue_type_script_setup_true_lang.BAAGAaVM.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/index.C8PB9l6c.js";import"./chunks/general.tY1gtZD0.js";const H={ctrl:"control",command:"meta",cmd:"meta",option:"alt",up:"arrowup",down:"arrowdown",left:"arrowleft",right:"arrowright"};function X(K={}){const{reactive:c=!1,target:A=$,aliasMap:D=H,passive:h=!0,onEventFired:B=O}=K,p=S(new Set),o={toJSON(){return{}},current:p},d=c?S(o):o,f=new Set,C=new Set,a=new Set;function u(k,n){k in d&&(c?d[k]=n:d[k].value=n)}function b(){p.clear();for(const k of a)u(k,!1)}function m(k,n){const g=k.key?.toLowerCase(),v=[k.code?.toLowerCase(),g].filter(Boolean);g&&(n?p.add(g):p.delete(g));for(const l of v)a.add(l),u(l,n);g==="shift"&&!n?(C.forEach(l=>{p.delete(l),u(l,!1)}),C.clear()):typeof k.getModifierState=="function"&&k.getModifierState("Shift")&&n&&[...p,...v].forEach(l=>C.add(l)),g==="meta"&&!n?(f.forEach(l=>{p.delete(l),u(l,!1)}),f.clear()):typeof k.getModifierState=="function"&&k.getModifierState("Meta")&&n&&[...p,...v].forEach(l=>f.add(l))}_(A,"keydown",k=>(m(k,!0),B(k)),{passive:h}),_(A,"keyup",k=>(m(k,!1),B(k)),{passive:h}),_("blur",b,{passive:h}),_("focus",b,{passive:h});const M=new Proxy(d,{get(k,n,g){if(typeof n!="string")return Reflect.get(k,n,g);if(n=n.toLowerCase(),n in D&&(n=D[n]),!(n in d))if(/[+_-]/.test(n)){const v=n.split(/[+_-]/g).map(l=>l.trim());d[n]=U(()=>v.map(l=>R(M[l])).every(Boolean))}else d[n]=z(!1);const x=Reflect.get(k,n,g);return c?R(x):x}});return M}const Y="/vue.svg",Z="/favicon.svg",Q={class:"flex flex-col md:flex-row"},ss={class:"flex gap-3 justify-center"},is={class:"flex gap-3 justify-center mt-3"},as={class:"text-center mt-4"},hs={class:"flex mt-2 justify-center space-x-1 min-h-1.5em"},ns=q({__name:"demo",setup(K){const{shift:c,v:A,u:D,e:h,s:B,v_u_e:p,u_s_e:o,current:d}=X(),f=U(()=>Array.from(d));return(C,a)=>{const u=w,b=w;return F(),E("div",Q,[s("img",{src:Y,class:P(["h-38 py-8 m-auto transform transition duration-500",{"opacity-0":!e(p),"rotate-180":e(c)}])},null,2),s("div",null,[t(u,{class:"text-center mt-0 mb-5"},{default:r(()=>a[0]||(a[0]=[i(" 按以下键测试 ")])),_:1,__:[0]}),s("div",ss,[t(y,{value:e(A)},{default:r(()=>a[1]||(a[1]=[i(" V ")])),_:1,__:[1]},8,["value"]),t(y,{value:e(D)},{default:r(()=>a[2]||(a[2]=[i(" u ")])),_:1,__:[2]},8,["value"]),t(y,{value:e(h)},{default:r(()=>a[3]||(a[3]=[i(" e ")])),_:1,__:[3]},8,["value"]),a[7]||(a[7]=s("div",{class:"mx-1"},null,-1)),t(y,{value:e(D)},{default:r(()=>a[4]||(a[4]=[i(" U ")])),_:1,__:[4]},8,["value"]),t(y,{value:e(B)},{default:r(()=>a[5]||(a[5]=[i(" s ")])),_:1,__:[5]},8,["value"]),t(y,{value:e(h)},{default:r(()=>a[6]||(a[6]=[i(" e ")])),_:1,__:[6]},8,["value"])]),s("div",is,[t(y,{value:e(c)},{default:r(()=>a[8]||(a[8]=[i(" Shift ")])),_:1,__:[8]},8,["value"]),t(y,{value:e(p)},{default:r(()=>a[9]||(a[9]=[i(" Vue ")])),_:1,__:[9]},8,["value"]),t(y,{value:e(o)},{default:r(()=>a[10]||(a[10]=[i(" Use ")])),_:1,__:[10]},8,["value"])]),s("div",as,[t(b,null,{default:r(()=>a[11]||(a[11]=[i("已按下的键")])),_:1,__:[11]}),s("div",hs,[(F(!0),E(L,null,W(f.value,m=>(F(),E("code",{key:m,class:"font-mono"},J(m),1))),128))])])]),s("img",{src:Z,class:P(["h-38 py-8 m-auto transform transition duration-500",{"opacity-0":!e(o),"rotate-180":e(c)}])},null,2)])}}}),ks=`<script setup lang="ts">
...
`,ls={class:"demo-source-link"},ts=["href"],ms=JSON.parse('{"title":"useMagicKeys","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useMagicKeys/index.md","filePath":"core/useMagicKeys/index.md","lastUpdated":1735397867000}'),es={name:"core/useMagicKeys/index.md"},vs=Object.assign(es,{setup(K){const A=G({template:{value:{welcomeSFC:ks}}}).serialize();return(D,h)=>{const B=j,p=V,o=N,d=I;return F(),E("div",null,[h[1]||(h[1]=s("h1",{id:"usemagickeys",tabindex:"-1"},[i("useMagicKeys "),s("a",{class:"header-anchor",href:"#usemagickeys","aria-label":"Permalink to “useMagicKeys”"},"​")],-1)),t(B,{fn:"useMagicKeys"}),h[2]||(h[2]=s("p",null,"响应式按键按下状态，支持神奇按键组合。",-1)),h[3]||(h[3]=s("h2",{id:"示例",tabindex:"-1"},[i("示例 "),s("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),t(p,null,{default:r(()=>[s("p",ls,[h[0]||(h[0]=s("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useMagicKeys/demo.vue",target:"_blank"},"源码",-1)),s("a",{href:`https://playground.vueuse.org/?vueuse=13.5.0${e(A)}`,target:"_blank"},"playground (beta)",8,ts)]),t(ns)]),_:1}),h[4]||(h[4]=T("",26)),h[5]||(h[5]=s("details",null,[s("summary",{op50:"",italic:"","cursor-pointer":"","select-none":""},"显示类型声明"),s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes vitesse-light vitesse-dark",style:{"--shiki-light":"#393a34","--shiki-dark":"#dbd7caee","--shiki-light-bg":"#ffffff","--shiki-dark-bg":"#121212"},tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"export"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}}," interface"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," UseMagicKeysOptions"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"<"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}},"Reactive"),s("span",{style:{"--shiki-light":"#AB5959","--shiki-dark":"#CB7676"}}," extends"),s("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," boolean"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},">"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}}," {")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}},"export"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}}," {"),s("span",{style:{"--shiki-light":"#B07D48","--shiki-dark":"#BD976A"}}," DefaultMagicKeysAliasMap"),s("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}}," }"),s("span",{style:{"--shiki-light":"#1E754F","--shiki-dark":"#4D9375"}}," from"),s("span",{style:{"--shiki-light":"#B5695977","--shiki-dark":"#C98A7D77"}},' "'),s("span",{style:{"--shiki-light":"#B56959","--shiki-dark":"#C98A7D"}},"./aliasMap"),s("span",{style:{"--shiki-light":"#B5695977","--shiki-dark":"#C98A7D77"}},'"')])])])])],-1)),h[6]||(h[6]=T("",3)),t(o,{fn:"useMagicKeys"}),h[7]||(h[7]=s("h2",{id:"更新日志",tabindex:"-1"},[i("更新日志 "),s("a",{class:"header-anchor",href:"#更新日志","aria-label":"Permalink to “更新日志”"},"​")],-1)),t(d,{fn:"useMagicKeys"})])}}});export{ms as __pageData,vs as default};
