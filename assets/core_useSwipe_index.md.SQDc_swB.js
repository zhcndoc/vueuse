import{_ as W,a as V}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.AiBx4Pr3.js";import{_ as $}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.Cn6cz7M5.js";import{_ as N}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DUJiisVJ.js";import{u as b}from"./chunks/index.qy4VQT1o.js";import{D as x,A as v,z as B,d as Y,i as R,o as P,j as i,n as I,q as z,H as c,y as s,t as w,Z as O,g as f,Y as T,w as j}from"./chunks/vue.K-Nh9t7y.js";import{_ as q}from"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/metadata.ByJC-ruD.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.B4vKqgz9.js";import"./chunks/general.tY1gtZD0.js";function H(D,u={}){const{threshold:o=50,onSwipe:r,onSwipeEnd:a,onSwipeStart:l,passive:g=!0}=u,h=x({x:0,y:0}),k=x({x:0,y:0}),n=v(()=>h.x-k.x),d=v(()=>h.y-k.y),{max:m,abs:t}=Math,S=v(()=>m(t(n.value),t(d.value))>=o),y=B(!1),C=v(()=>S.value?t(n.value)>t(d.value)?n.value>0?"left":"right":d.value>0?"up":"down":"none"),_=e=>[e.touches[0].clientX,e.touches[0].clientY],U=(e,p)=>{h.x=e,h.y=p},F=(e,p)=>{k.x=e,k.y=p},A={passive:g,capture:!g},X=e=>{y.value&&a?.(e,C.value),y.value=!1},M=[b(D,"touchstart",e=>{if(e.touches.length!==1)return;const[p,E]=_(e);U(p,E),F(p,E),l?.(e)},A),b(D,"touchmove",e=>{if(e.touches.length!==1)return;const[p,E]=_(e);F(p,E),A.capture&&!A.passive&&Math.abs(n.value)>Math.abs(d.value)&&e.preventDefault(),!y.value&&S.value&&(y.value=!0),y.value&&r?.(e)},A),b(D,["touchend","touchcancel"],X,A)];return{isSwiping:y,direction:C,coordsStart:h,coordsEnd:k,lengthX:n,lengthY:d,stop:()=>M.forEach(e=>e()),isPassiveEventSupported:!0}}const L={class:"status"},G=Y({__name:"demo",setup(D){const u=B(null),o=B(null),r=v(()=>o.value?.offsetWidth),a=B("0"),l=B(1);function g(){a.value="0",l.value=1}const{direction:h,isSwiping:k,lengthX:n,lengthY:d}=H(u,{passive:!1,onSwipe(m){if(r.value)if(n.value<0){const t=Math.abs(n.value);a.value=`${t}px`,l.value=1.1-t/r.value}else a.value="0",l.value=1},onSwipeEnd(m,t){n.value<0&&r.value&&Math.abs(n.value)/r.value>=.5?(a.value="100%",l.value=0):(a.value="0",l.value=1)}});return(m,t)=>(P(),R("div",null,[i("div",{ref_key:"container",ref:o,class:"container select-none"},[i("button",{onClick:g}," 重置 "),i("div",{ref_key:"target",ref:u,class:z(["overlay",{animated:!c(k)}]),style:I({left:a.value,opacity:l.value})},t[0]||(t[0]=[i("p",null,"向右滑动",-1)]),6)],512),i("p",L,[s(" 方向："+w(c(h)?c(h):"-")+" ",1),t[1]||(t[1]=i("br",null,null,-1)),s(" 水平长度："+w(c(n))+" | 垂直长度："+w(c(d)),1)])]))}}),J=q(G,[["__scopeId","data-v-a3890d38"]]),Z=`<script setup lang="ts">
...
`,K={class:"demo-source-link"},Q=["href"],oi=JSON.parse('{"title":"useSwipe","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useSwipe/index.md","filePath":"core/useSwipe/index.md","lastUpdated":1737604618000}'),ii={name:"core/useSwipe/index.md"},gi=Object.assign(ii,{setup(D){const o=O({template:{value:{welcomeSFC:Z}}}).serialize();return(r,a)=>{const l=N,g=$,h=W,k=V;return P(),R("div",null,[a[1]||(a[1]=i("h1",{id:"useswipe",tabindex:"-1"},[s("useSwipe "),i("a",{class:"header-anchor",href:"#useswipe","aria-label":"Permalink to “useSwipe”"},"​")],-1)),f(l,{fn:"useSwipe"}),a[2]||(a[2]=i("p",null,[s("基于 "),i("a",{href:"https://developer.mozilla.org/en-US/docs/Web/API/TouchEvent",target:"_blank",rel:"noreferrer"},[i("code",null,"TouchEvents")]),s(" 的响应式滑动检测。")],-1)),a[3]||(a[3]=i("h2",{id:"示例",tabindex:"-1"},[s("示例 "),i("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),f(g,null,{default:j(()=>[i("p",K,[a[0]||(a[0]=i("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useSwipe/demo.vue",target:"_blank"},"源码",-1)),i("a",{href:`https://playground.vueuse.org/?vueuse=13.6.0${c(o)}`,target:"_blank"},"playground (beta)",8,Q)]),f(J)]),_:1}),a[4]||(a[4]=T(`<h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-label="Permalink to “用法”">​</a></h2><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666;">&lt;</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">script</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> setup</span><span style="--shiki-light:#999999;--shiki-dark:#666666;">&gt;</span></span>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#999999","--shiki-dark":"#666666"}},"):"),i("span",{style:{"--shiki-light":"#2E8F82","--shiki-dark":"#5DA994"}}," UseSwipeReturn")])])])])],-1)),a[6]||(a[6]=T('<h2 id="源码" tabindex="-1">源码 <a class="header-anchor" href="#源码" aria-label="Permalink to “源码”">​</a></h2><p><a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSwipe/index.ts" target="_blank" rel="noreferrer">源码</a> • <a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSwipe/demo.vue" target="_blank" rel="noreferrer">演示</a> • <a href="https://github.com/vueuse/vueuse/blob/main/packages/core/useSwipe/index.md" target="_blank" rel="noreferrer">文档</a></p><h2 id="贡献者" tabindex="-1">贡献者 <a class="header-anchor" href="#贡献者" aria-label="Permalink to “贡献者”">​</a></h2>',3)),f(h,{fn:"useSwipe"}),a[7]||(a[7]=i("h2",{id:"更新日志",tabindex:"-1"},[s("更新日志 "),i("a",{class:"header-anchor",href:"#更新日志","aria-label":"Permalink to “更新日志”"},"​")],-1)),f(k,{fn:"useSwipe"})])}}});export{oi as __pageData,gi as default};
