import{_,a as F}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as E}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as I}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{_ as x}from"./chunks/BooleanDisplay.vue_vue_type_script_setup_true_lang.y710iK4K.js";import{_ as w}from"./chunks/Note.BA4Afsl9.js";import{d as S,h as c}from"./chunks/metadata.DSy5Z-Tw.js";import{u}from"./chunks/index.CHzdlLbS.js";import{t as P,c as T}from"./chunks/filters.CNOy65Bq.js";import{z as m,d as V,A as $,i as B,o as f,F as N,g as t,j as i,w as v,y as e,H as b,t as R,Z as U,Y as j}from"./chunks/vue.DDc96eEg.js";import{u as O}from"./chunks/index.f9C4AmUw.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/index.C8PB9l6c.js";import"./chunks/general.tY1gtZD0.js";import"./chunks/index.Cic7SbUz.js";const z=["mousemove","mousedown","resize","keydown","touchstart","wheel"],q=6e4;function W(d=q,p={}){const{initialState:h=!1,listenForVisibilityChange:r=!0,events:s=z,window:n=S,eventFilter:a=P(50)}=p,l=m(h),k=m(c());let o;const g=()=>{l.value=!1,clearTimeout(o),o=setTimeout(()=>l.value=!0,d)},y=T(a,()=>{k.value=c(),g()});if(n){const A=n.document,D={passive:!0};for(const C of s)u(n,C,y,D);r&&u(A,"visibilitychange",()=>{A.hidden||y()},D),h||g()}return{idle:l,lastActive:k,reset:g}}const M={class:"mb-2"},H={class:"text-primary"},J=V({__name:"demo",setup(d){const{idle:p,lastActive:h}=W(5e3),r=O({interval:1e3}),s=$(()=>{const n=Math.floor((r.value-h.value)/1e3);return n>0?n:0});return(n,a)=>{const l=w,k=x;return f(),B(N,null,[t(l,{class:"mb-2"},{default:v(()=>a[0]||(a[0]=[e(" 为了演示目的，在此演示中将空闲超时设置为 "),i("b",null,"5秒",-1),e("（默认为1分钟）。 ")])),_:1,__:[0]}),i("div",M,[a[1]||(a[1]=e(" 空闲状态: ")),t(k,{value:b(p)},null,8,["value"])]),i("div",null,[a[2]||(a[2]=e("非活动时间: ")),i("b",H,R(s.value)+"秒",1)])],64)}}}),L=`<script setup lang="ts">
