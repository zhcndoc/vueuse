import{_ as R,a as _}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as C}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as H}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{_ as F}from"./chunks/Note.BA4Afsl9.js";import{d as E,z as x,i as p,o,F as D,j as s,a2 as w,g as h,t as m,H as t,a5 as S,w as b,y as k,O as $,Z as P,Y as T}from"./chunks/vue.DDc96eEg.js";import{u as Y}from"./chunks/index.yB95-HvP.js";import{d as U}from"./chunks/filters.CNOy65Bq.js";import{u as V}from"./chunks/index.DUCiHM5u.js";import{f as z}from"./chunks/index.DxEqsuNn.js";import"./chunks/metadata.DSy5Z-Tw.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/plugin-vue_export-helper.DlAUqK2U.js";import"./chunks/index.ejyDfVZ_.js";import"./chunks/index.B5gtmQUn.js";import"./chunks/index.YwqJXHuf.js";import"./chunks/index.Cic7SbUz.js";function M(d,l={}){const e=l.debounce?U(l.debounce):void 0;return{...Y(d,{...l,eventFilter:e})}}const N=["disabled"],O=["disabled"],I={class:"code-block mt-4"},j={class:"opacity-50 mr-2 font-mono"},q={class:"font-mono"},G=E({__name:"demo",setup(d){function l(f){return z(new Date(f),"YYYY-MM-DD HH:mm:ss")}const e=x(1e3),{count:r,inc:a,dec:u}=V(),{history:y,undo:g,redo:c,canUndo:A,canRedo:v}=M(r,{capacity:10,debounce:e});return(f,i)=>{const B=F;return o(),p(D,null,[s("div",null,"Count: "+m(t(r)),1),s("button",{onClick:i[0]||(i[0]=n=>t(a)())}," 增加 "),s("button",{onClick:i[1]||(i[1]=n=>t(u)())}," 减少 "),i[6]||(i[6]=s("span",{class:"ml-2"},"/",-1)),s("button",{disabled:!t(A),onClick:i[2]||(i[2]=n=>t(g)())}," 撤消 ",8,N),s("button",{disabled:!t(v),onClick:i[3]||(i[3]=n=>t(c)())}," 重做 ",8,O),i[7]||(i[7]=s("br",null,null,-1)),i[8]||(i[8]=s("span",null,"延迟（毫秒）:",-1)),w(s("input",{"onUpdate:modelValue":i[4]||(i[4]=n=>e.value=n),type:"number"},null,512),[[S,e.value]]),i[9]||(i[9]=s("br",null,null,-1)),i[10]||(i[10]=s("br",null,null,-1)),h(B,null,{default:b(()=>i[5]||(i[5]=[k("历史记录（仅限演示，最多保存10条记录）")])),_:1,__:[5]}),s("div",I,[(o(!0),p(D,null,$(t(y),n=>(o(),p("div",{key:n.timestamp},[s("span",j,m(l(n.timestamp)),1),s("span",q,"{ value: "+m(n.snapshot)+" }",1)]))),128))])],64)}}}),J=`<script setup lang="ts">
