import{_ as c,a as D}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.aYHrlqwd.js";import{_ as A}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{a as u,_ as f}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.BPSCnKkW.js";import{u as B}from"./chunks/index.rocSL1WN.js";import{r as v,d as b,i as k,H as t,o as r,k as _,F as C,j as s,t as d,Z as S,g as h,Y as F,y as o,w as M}from"./chunks/vue.DDc96eEg.js";import"./chunks/metadata.BfYDMb5p.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.BrP_zX4n.js";function x(p={}){const e=v(),l=B(()=>typeof performance<"u"&&"memory"in performance);if(l.value){const{interval:n=1e3}=p;u(()=>{e.value=performance.memory},n,{immediate:p.immediate,immediateCallback:p.immediateCallback})}return{isSupported:l,memory:e}}const E={key:0,class:"inline-grid grid-cols-2 gap-x-4 gap-y-2"},z={key:1},P=b({__name:"demo",setup(p){function e(i){return`${(i/1024/1024).toFixed(2)} MB`}const{isSupported:l,memory:n}=x();return(i,a)=>t(l)&&t(n)?(r(),k("div",E,[t(n)?(r(),k(C,{key:0},[a[0]||(a[0]=s("div",{opacity:"50"}," 已使用 ",-1)),s("div",null,d(e(t(n).usedJSHeapSize)),1),a[1]||(a[1]=s("div",{opacity:"50"}," 已分配 ",-1)),s("div",null,d(e(t(n).totalJSHeapSize)),1),a[2]||(a[2]=s("div",{opacity:"50"}," 限制 ",-1)),s("div",null,d(e(t(n).jsHeapSizeLimit)),1)],64)):_("",!0)])):(r(),k("div",z," 你的浏览器不支持性能内存 API "))}}),I=`<script lang="ts" setup>
