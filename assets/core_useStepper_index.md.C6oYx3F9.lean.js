import{_ as U,a as j}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.AiBx4Pr3.js";import{_ as L}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.Cn6cz7M5.js";import{_ as $}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DUJiisVJ.js";import{r as x,A as c,d as M,D as I,i as r,o as d,j as s,F as J,O as z,t as f,H as p,k as u,a2 as y,a5 as v,ad as F,al as E,V as H,Z as Y,g as A,Y as S,y as i,w as Z}from"./chunks/vue.K-Nh9t7y.js";import"./chunks/metadata.ByJC-ruD.js";import"./chunks/utils.B5e_uQLX.js";function q(B,l){const t=x(B),k=c(()=>Array.isArray(t.value)?t.value:Object.keys(t.value)),n=x(k.value.indexOf(k.value[0])),o=c(()=>D(n.value)),a=c(()=>n.value===0),e=c(()=>n.value===k.value.length-1),g=c(()=>k.value[n.value+1]),m=c(()=>k.value[n.value-1]);function D(h){return Array.isArray(t.value)?t.value[h]:t.value[k.value[h]]}function _(h){if(k.value.includes(h))return D(k.value.indexOf(h))}function b(h){k.value.includes(h)&&(n.value=k.value.indexOf(h))}function T(){e.value||n.value++}function N(){a.value||n.value--}function V(h){C(h)&&b(h)}function P(h){return k.value.indexOf(h)===n.value+1}function R(h){return k.value.indexOf(h)===n.value-1}function O(h){return k.value.indexOf(h)===n.value}function w(h){return n.value<k.value.indexOf(h)}function C(h){return n.value>k.value.indexOf(h)}return{steps:t,stepNames:k,index:n,current:o,next:g,previous:m,isFirst:a,isLast:e,at:D,get:_,goTo:b,goToNext:T,goToPrevious:N,goBackTo:V,isNext:P,isPrevious:R,isCurrent:O,isBefore:w,isAfter:C}}const G={class:"flex gap-2 justify-center"},K=["disabled","onClick","textContent"],Q=["textContent"],W={class:"flex flex-col justify-center gap-2 mt-2"},X={key:0},ss={key:1},is={key:2},as={key:3},ns=["disabled"],ts=["disabled"],ls={class:"flex flex-col gap-4 mt-12"},es={class:"w-full px-4 py-2 rounded border border-main space-y-2 overflow-auto h-full"},hs=["textContent"],ks={class:"w-full px-4 py-2 rounded border border-main space-y-2 overflow-auto h-full"},ps=["textContent"],rs=M({__name:"demo",setup(B){const l=I({firstName:"Jon",lastName:"",billingAddress:"",contractAccepted:!1,carbonOffsetting:!1,payment:"credit-card"}),t=q({"user-information":{title:"User information",isValid:()=>l.firstName&&l.lastName},"billing-address":{title:"Billing address",isValid:()=>l.billingAddress?.trim()!==""},terms:{title:"Terms",isValid:()=>l.contractAccepted===!0},payment:{title:"Payment",isValid:()=>["credit-card","paypal"].includes(l.payment)}});function k(){t.current.value.isValid()&&t.goToNext()}function n(o){return!Array.from({length:o},()=>null).some((a,e)=>!t.at(e)?.isValid())}return(o,a)=>(d(),r("div",null,[s("div",G,[(d(!0),r(J,null,z(p(t).steps.value,(e,g,m)=>(d(),r("div",{key:g,class:""},[s("button",{disabled:!n(m)&&p(t).isBefore(g),onClick:D=>p(t).goTo(g),textContent:f(e.title)},null,8,K)]))),128))]),s("form",{class:"mt-10",onSubmit:H(k,["prevent"])},[s("span",{class:"text-lg font-bold",textContent:f(p(t).current.value.title)},null,8,Q),s("div",W,[s("div",null,[p(t).isCurrent("user-information")?(d(),r("div",X,[a[7]||(a[7]=s("span",null,"姓氏：",-1)),y(s("input",{"onUpdate:modelValue":a[0]||(a[0]=e=>l.lastName=e),class:"!mt-0.5",type:"text"},null,512),[[v,l.lastName]]),a[8]||(a[8]=s("span",null,"名字：",-1)),y(s("input",{"onUpdate:modelValue":a[1]||(a[1]=e=>l.firstName=e),class:"!mt-0.5",type:"text"},null,512),[[v,l.firstName]])])):u("",!0),p(t).isCurrent("billing-address")?(d(),r("div",ss,[y(s("input",{"onUpdate:modelValue":a[2]||(a[2]=e=>l.billingAddress=e),type:"text"},null,512),[[v,l.billingAddress]])])):u("",!0),p(t).isCurrent("terms")?(d(),r("div",is,[s("div",null,[y(s("input",{id:"carbon-offsetting","onUpdate:modelValue":a[3]||(a[3]=e=>l.carbonOffsetting=e),type:"checkbox",class:"mr-2"},null,512),[[F,l.carbonOffsetting]]),a[9]||(a[9]=s("label",{for:"carbon-offsetting"},"我同意支付碳抵消费用",-1))]),s("div",null,[y(s("input",{id:"contract","onUpdate:modelValue":a[4]||(a[4]=e=>l.contractAccepted=e),type:"checkbox",class:"mr-2"},null,512),[[F,l.contractAccepted]]),a[10]||(a[10]=s("label",{for:"contract"},"我接受合同条款",-1))])])):u("",!0),p(t).isCurrent("payment")?(d(),r("div",as,[s("div",null,[y(s("input",{id:"credit-card","onUpdate:modelValue":a[5]||(a[5]=e=>l.payment=e),type:"radio",class:"mr-2",value:"credit-card"},null,512),[[E,l.payment]]),a[11]||(a[11]=s("label",{for:"credit-card"},"信用卡",-1))]),s("div",null,[y(s("input",{id:"paypal","onUpdate:modelValue":a[6]||(a[6]=e=>l.payment=e),type:"radio",class:"mr-2",value:"paypal"},null,512),[[E,l.payment]]),a[12]||(a[12]=s("label",{for:"paypal"},"PayPal",-1))])])):u("",!0)]),s("div",null,[p(t).isLast.value?u("",!0):(d(),r("button",{key:0,disabled:!p(t).current.value.isValid()}," 下一步 ",8,ns)),p(t).isLast.value?(d(),r("button",{key:1,disabled:!p(t).current.value.isValid()}," 提交 ",8,ts)):u("",!0)])])],32),s("div",ls,[s("div",es,[a[13]||(a[13]=s("span",{class:"font-bold"},"表单",-1)),s("pre",{textContent:f(l)},null,8,hs)]),s("div",ks,[a[14]||(a[14]=s("span",{class:"font-bold"},"向导",-1)),s("pre",{textContent:f(p(t))},null,8,ps)])])]))}}),ds=`<script setup lang="ts">
