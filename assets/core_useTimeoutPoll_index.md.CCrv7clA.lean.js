import{_ as A,a as D}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.CIm_UbOG.js";import{_ as f}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.CTa0lAlj.js";import{_ as B}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DMwR8dBP.js";import{a as b,t as v}from"./chunks/metadata.DSy5Z-Tw.js";import{u as _}from"./chunks/index.DIaNeo4z.js";import{z as c,d as C,i as y,o as m,j as i,t as g,H as l,Z as P,g as r,Y as T,y as d,w as F}from"./chunks/vue.DDc96eEg.js";import{b as x}from"./chunks/general.tY1gtZD0.js";import"./chunks/utils.B5e_uQLX.js";function E(o,h,k={}){const{immediate:p=!0,immediateCallback:s=!1}=k,{start:e}=_(n,h,{immediate:p}),a=c(!1);async function n(){a.value&&(await o(),e())}function t(){a.value||(a.value=!0,s&&o(),e())}function u(){a.value=!1}return p&&b&&t(),v(u),{isActive:a,pause:u,resume:t}}const w=C({__name:"demo",setup(o){const h=c(0);async function k(){await x(1e3),h.value++}const{isActive:p,pause:s,resume:e}=E(k,1e3);return(a,n)=>(m(),y("div",null,[i("div",null,"Count: "+g(h.value),1),i("div",null,"isActive: "+g(l(p)),1),i("div",null,[i("button",{onClick:n[0]||(n[0]=(...t)=>l(s)&&l(s)(...t))}," 暂停 "),i("button",{onClick:n[1]||(n[1]=(...t)=>l(e)&&l(e)(...t))}," 恢复 ")])]))}}),S=`<script setup lang="ts">
