...
`,ys={class:"demo-source-link"},gs=["href"],Cs=JSON.parse('{"title":"useSpeechSynthesis","description":"","frontmatter":{"category":"Sensors"},"headers":[],"relativePath":"core/useSpeechSynthesis/index.md","filePath":"core/useSpeechSynthesis/index.md","lastUpdated":1715934697000}'),cs={name:"core/useSpeechSynthesis/index.md"},xs=Object.assign(cs,{setup(B){const y=q({template:{value:{welcomeSFC:os}}}).serialize();return(c,a)=>{const p=I,n=T,g=V,l=$;return A(),u("div",null,[a[1]||(a[1]=s("h1",{id:"usespeechsynthesis",tabindex:"-1"},[i("useSpeechSynthesis "),s("a",{class:"header-anchor",href:"#usespeechsynthesis","aria-label":"Permalink to “useSpeechSynthesis”"},"​")],-1)),b(p,{fn:"useSpeechSynthesis"}),a[2]||(a[2]=s("p",null,[i("响应式 "),s("a",{href:"https://developer.mozilla.org/en-US/docs/Web/API/SpeechSynthesis",target:"_blank",rel:"noreferrer"},"SpeechSynthesis"),i("。")],-1)),a[3]||(a[3]=s("blockquote",null,[s("p",null,[s("a",{href:"https://caniuse.com/mdn-api_speechsynthesis",target:"_blank",rel:"noreferrer"},"Can I use?")])],-1)),a[4]||(a[4]=s("h2",{id:"示例",tabindex:"-1"},[i("示例 "),s("a",{class:"header-anchor",href:"#示例","aria-label":"Permalink to “示例”"},"​")],-1)),b(n,null,{default:H(()=>[s("p",ys,[a[0]||(a[0]=s("a",{href:"https://github.com/vueuse/vueuse/blob/main/packages/core/useSpeechSynthesis/demo.vue",target:"_blank"},"源码",-1)),s("a",{href:`https://playground.vueuse.org/?vueuse=13.6.0${D(y)}`,target:"_blank"},"playground (beta)",8,gs)]),b(ds)]),_:1}),a[5]||(a[5]=F(`<h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-label="Permalink to “用法”">​</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes vitesse-light vitesse-dark" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;">import</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> {</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A;"> useSpeechSynthesis</span><span style="--shiki-light:#999999;--shiki-dark:#666666;"> }</span><span style="--shiki-light:#1E754F;--shiki-dark:#4D9375;"> from</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;"> &#39;</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">@vueuse/core</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77;">&#39;</span></span>
