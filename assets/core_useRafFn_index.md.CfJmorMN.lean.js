import{_ as u,a as f}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.B34KrB-E.js";import{_ as m}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.D4TFK0oQ.js";import{u as B,_ as F}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.Dvv1reKl.js";import{d as b,z as o,i as D,o as A,F as _,j as s,t as d,H as e,Z as v,g as t,Y as C,y as l,w as R}from"./chunks/vue.BjJVtbJX.js";import"./chunks/metadata.CHQ7S0zC.js";import"./chunks/utils.B5e_uQLX.js";const E={"font-mono":""},x={"font-mono":""},g=60,P=b({__name:"demo",setup(y){const p=o(0),h=o(0),{pause:r,resume:i}=B(({delta:k})=>{h.value=k,p.value+=1},{fpsLimit:g});return(k,a)=>(A(),D(_,null,[s("div",E," 帧数："+d(p.value),1),s("div",x," 间隔时间："+d(h.value.toFixed(0))+"毫秒 ",1),s("div",{"font-mono":""}," FPS 限制："+d(g)),s("button",{onClick:a[0]||(a[0]=(...n)=>e(r)&&e(r)(...n))}," 暂停 "),s("button",{onClick:a[1]||(a[1]=(...n)=>e(i)&&e(i)(...n))}," 恢复 ")],64))}}),S=`<script setup lang="ts">
