import{_ as D,a as E}from"./chunks/Contributors.vue_vue_type_script_setup_true_lang.AiBx4Pr3.js";import{_ as A}from"./chunks/DemoContainer.vue_vue_type_script_setup_true_lang.Cn6cz7M5.js";import{_ as b}from"./chunks/FunctionInfo.vue_vue_type_script_setup_true_lang.DUJiisVJ.js";import{u as o}from"./chunks/index.D8zH5v3j.js";import{u as v}from"./chunks/index.D3s4RrBr.js";import{u as x}from"./chunks/index.qy4VQT1o.js";import{u as C}from"./chunks/index.BNnEPRNw.js";import{u as _}from"./chunks/index.Cd8CH7TY.js";import{d as P,D as g,A as u,i as m,o as B,F,j as i,t as y,H as l,n as c,Z as $,g as t,Y as S,y as r,w}from"./chunks/vue.K-Nh9t7y.js";import"./chunks/metadata.ByJC-ruD.js";import"./chunks/utils.B5e_uQLX.js";import"./chunks/index.BGs_z4hs.js";import"./chunks/index.B4vKqgz9.js";import"./chunks/index.CLp6I5-5.js";import"./chunks/index.BImTs33O.js";import"./chunks/index.B2rzktNR.js";import"./chunks/general.tY1gtZD0.js";import"./chunks/index.DtiJt5gQ.js";import"./chunks/index.C6vnENxY.js";const N=P({__name:"demo",setup(f){const{x:d,y:h}=C({type:"client"}),{element:e}=v({x:d,y:h}),s=_(e),n=g(o(s)),a=g(o(e));x("scroll",[n.update,a.update],{passive:!0,capture:!0});const p=u(()=>e.value?{display:"block",width:`${a.width}px`,height:`${a.height}px`,left:`${a.left}px`,top:`${a.top}px`,backgroundColor:"#a5a5a544",transition:"all 0.05s linear"}:{display:"none"}),k=u(()=>s.value?{display:"block",width:`${n.width}px`,height:`${n.height}px`,left:`${n.left}px`,top:`${n.top}px`,backgroundColor:"#3eaf7c44",transition:"all 0.05s linear"}:{display:"none"});return(z,q)=>(B(),m(F,null,[i("p",null,"Current element tag: "+y(l(e)?l(e).tagName:"Finding..."),1),i("p",null,"Parent element tag: "+y(l(s)?l(s).tagName:"Finding..."),1),i("div",{style:c(k.value),fixed:"","pointer-events-none":"","z-9999":"",border:"1 $vp-c-brand"},null,4),i("div",{style:c(p.value),fixed:"","pointer-events-none":"","z-9999":"",border:"1 $vp-c-brand"},null,4)],64))}}),T=`<script lang="ts" setup>
